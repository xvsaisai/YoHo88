 ...
 */
public abstract class FenleiPinpaiBaseFragment extends LazyBaseFragment {

    public ListView lvletter;
    ...
    public HrizotalScrollView tuijian;
    public View pinpai;
    public RadioButton rd_quanbu;
    public RadioButton rd_xin;
    public RadioButton rd_remen;
    public FenleiPinpaiBoyExpandAdapter adapter;
    public ArrayAdapter letterAdapter;
    public List<String> letter;
    public List<PinPaiBean.BrandBean> brand;
    public List<PinPaiParentBean> pinpaiParentList;


    @Override
    protected int getLayoutId() {
        return R.layout.fragment_fenlei_pinpai_child;
    }

    @Override
    protected void initView() {
        lvletter = findView(R.id.lv_letter);
        empty = findView(R.id.empty);
        pbempty = findView(R.id.pb_empty);
        tvempty = findView(R.id.tv_empty);
        expand = findView(R.id.expand);
...
//                Toast.makeText(activity,pinpaiParentList.get(groupPosition).getList().get(childPosition).getName(),Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getActivity(), PinPaiXiangqingActivity.class);
                ...
                getActivity().overridePendingTransition(R.anim.pinpai_xiangqing_activity_in, R.anim.main_activity_toleft);
                return true;
            }
        });
...
//        letterAdapter = new ArrayAdapter<>(getContext(), R.layout.item_lv_letter, R.id.letter_item_tv, letter);
//        lvletter.setAdapter(letterAdapter);
    }

    private void initHead() {
        search = View.inflate(getContext(), R.layout.item_search, null);
        ...
        tuijian = new HrizotalScrollView(getContext());
        ...
        pinpai = View.inflate(getContext(), R.layout.item_fenlei_pinpai_pinpaifenlei, null);
